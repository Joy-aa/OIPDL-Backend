...
//            modelInfo.setModelPath(modelReq.getModelPath());
            modelInfo.setModelPath("10.214.211.106:8888/3dmodel/car.glb");
    ...
    @ApiOperation("展示所有模型")
    @PostMapping("findAll")
    public ResultBean<FindModelRes> findModelByUser(@RequestBody FindModelsByUserReq req, @CookieValue("userTicket")String ticket) {
